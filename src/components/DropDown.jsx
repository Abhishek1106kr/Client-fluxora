    ...
    return (
        <div className="relative inline-block text-left w-full md:w-auto">
            <button 
                ...
                className="flex items-center justify-between gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900 px-3.5 py-1.5 text-sm font-medium text-zinc-200 shadow-sm transition hover:bg-zinc-800/80 hover:text-zinc-100 w-full md:w-auto"
            >
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute right-0 mt-2 z-50 w-52 origin-top-right rounded-xl border border-zinc-800 bg-zinc-900 p-1.5 shadow-2xl animate-in fade-in slide-in-from-top-1 duration-100">
                        {options.map((option) => {
